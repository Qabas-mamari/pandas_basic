...
## what is ?
pandas is an open-source library that provides high-performance, easy-to-use data structures, and data analysis tools for Python. In this repository will learn how to use the pandas library and tools for data analysis and data structuring. We will go into topics such as DataFrames, basic plotting, indexing, and groupby using public data set: the Olympic medal winners from 1896 to 2008.
